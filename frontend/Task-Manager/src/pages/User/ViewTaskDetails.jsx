                    ...
                    {task && (<div className="grid grid-cols-1 md:grid-cols-4 mt-4">
                        <div className="form-card col-span-3">
                            <div className="flex items-center justify-between">
                                <h2 className="text-xl md:text-cl font-bold">
                                    {task?.title}
                                </h2>
                                <div
                            ...
                            {task?.attachments?.length > 0 && (
                                <div className="mt-2">
                                    <label className="text-xs font-medium text-slate-500">Attachmetns</label>
...
const TodoChecklist = ({text, isChecked, onChange}) => {
    return <div className="flex items-center gap-3 p-3"> 
                <input type="checkbox" checked={isChecked} onChange={onChange} className = "w-4 h-4 bg-blue-500 bg-gray-100 border-gray-300 rounded-sm outline-none cursor-pointer" />
