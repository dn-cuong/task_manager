            ...
            <table className="min-w-full">
                <thead>
                    <tr className="text-left">
                        ...
                        <th className="py-3 px-4 text-gray-800 font-medium text-[13px] hidden:table-cell">Created On</th>
                    </tr>
                </thead>
            <tbody>
                {tableData.map((task) => (
                    <tr key = {task._id} className="border-t border-gray-200">
                        ...
                        <td className="py-4 px-4 text-gray-700 text-[13px] text-nowrap hidden md:tabel-cell">{task.createdAt ? moment(task.createdAt).format(`Do MMM YYYY`) : 'N/A'}</td>
                    </tr>
